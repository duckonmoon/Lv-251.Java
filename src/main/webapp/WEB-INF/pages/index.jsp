            ...
            <div  class="container-fluid">
                    ...
                    <div class="navbar-form " >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="autocomplete" style="width: 560px" placeholder='<spring:message code="messages.searchClinics"/>'aria-describedby="sizing-addon1">
                            </div>
